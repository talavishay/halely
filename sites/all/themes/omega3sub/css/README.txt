...
To use these stylesheets, rename the files and omega3sub with the name of your theme.
...
omega3sub-alpha-default-narrow.css  
...
omega3sub-alpha-default-normal.css
...
omega3sub-alpha-default-wide.css
